...
4. **Identifica il Backend**
   - Vedrai 2 servizi:
     ...
     * **Backend**: Un URL Emergent tipo `https://[qualcosa].emergent.host` o `https://leadmanager-21.preview.emergentagent.com`
...
Esempio: https://leadmanager-21.preview.emergentagent.com
```
...
Oppure:
```
Il mio backend URL è: https://leadmanager-21.preview.emergentagent.com
```
