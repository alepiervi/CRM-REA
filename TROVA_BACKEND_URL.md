...
4. **Identifica il Backend**
   - Vedrai 2 servizi:
     ...
     * **Backend**: Un URL Emergent tipo `https://[qualcosa].emergent.host` o `https://cloudfile-fix.preview.emergentagent.com`
...
Esempio: https://cloudfile-fix.preview.emergentagent.com
```
...
Oppure:
```
Il mio backend URL è: https://cloudfile-fix.preview.emergentagent.com
```
