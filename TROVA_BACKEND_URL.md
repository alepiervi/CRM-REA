...
4. **Identifica il Backend**
   - Vedrai 2 servizi:
     ...
     * **Backend**: Un URL Emergent tipo `https://[qualcosa].emergent.host` o `https://referente-oversight.preview.emergentagent.com`
...
curl https://referente-oversight.preview.emergentagent.com/api/health
...
Esempio: https://referente-oversight.preview.emergentagent.com
```
...
Oppure:
```
Il mio backend URL è: https://referente-oversight.preview.emergentagent.com
```
