...
4. **Identifica il Backend**
   - Vedrai 2 servizi:
     ...
     * **Backend**: Un URL Emergent tipo `https://[qualcosa].emergent.host` o `https://agentify-6.preview.emergentagent.com`
...
Esempio: https://agentify-6.preview.emergentagent.com
```
...
Oppure:
```
Il mio backend URL è: https://agentify-6.preview.emergentagent.com
```
