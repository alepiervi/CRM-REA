...
4. **Identifica il Backend**
   - Vedrai 2 servizi:
     ...
     * **Backend**: Un URL Emergent tipo `https://[qualcosa].emergent.host` o `https://nureal-crm-2.preview.emergentagent.com`
...
Esempio: https://nureal-crm-2.preview.emergentagent.com
```
...
Oppure:
```
Il mio backend URL è: https://nureal-crm-2.preview.emergentagent.com
```
