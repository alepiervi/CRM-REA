...
4. **Identifica il Backend**
   - Vedrai 2 servizi:
     ...
     * **Backend**: Un URL Emergent tipo `https://[qualcosa].emergent.host` o `https://crm-bug-tracker.preview.emergentagent.com`
...
Esempio: https://crm-bug-tracker.preview.emergentagent.com
```
...
Oppure:
```
Il mio backend URL è: https://crm-bug-tracker.preview.emergentagent.com
```
