...
4. **Identifica il Backend**
   - Vedrai 2 servizi:
     ...
     * **Backend**: Un URL Emergent tipo `https://[qualcosa].emergent.host` o `https://referente-hub.preview.emergentagent.com`
...
Esempio: https://referente-hub.preview.emergentagent.com
```
...
Oppure:
```
Il mio backend URL è: https://referente-hub.preview.emergentagent.com
```
