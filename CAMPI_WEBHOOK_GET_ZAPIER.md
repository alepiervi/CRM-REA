...
### Esempio 1: Lead Base
```
https://lead-master-7.preview.emergentagent.com/api/webhook/251eb0e5-f4b3-4837-9f05-8f8eec6f62d0?nome=Mario&cognome=Rossi&telefono=3331234567&email=mario@example.com&provincia=Milano&commessa_id=abc123
```
...
```
https://lead-master-7.preview.emergentagent.com/api/webhook/251eb0e5-f4b3-4837-9f05-8f8eec6f62d0?nome={{1. First Name}}&cognome={{1. Last Name}}&telefono={{1. Phone}}&email={{1. Email}}&provincia={{1. City}}&commessa_id=abc123-def456&campagna=FacebookLeads2025
```
