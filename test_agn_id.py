...
def test_trova_id_unit_agn():
    ...
    base_url = "https://commessa-crm-hub.preview.emergentagent.com/api"
    ...
    if unit_agn:
        agn_id = unit_agn.get('id')
        base_webhook_url = "https://commessa-crm-hub.preview.emergentagent.com/api/webhook"
    ...
    if unit_agn:
        agn_id = unit_agn.get('id')
        agn_is_active = unit_agn.get('is_active', False)
        webhook_url = f"https://commessa-crm-hub.preview.emergentagent.com/api/webhook/{agn_id}"
