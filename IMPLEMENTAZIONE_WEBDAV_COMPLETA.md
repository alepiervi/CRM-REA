...
curl https://bulk-upload-clients.preview.emergentagent.com/api/documents/upload-debug
...
4. Controlla endpoint debug:
   ```
   https://bulk-upload-clients.preview.emergentagent.com/api/documents/upload-debug
   ```
5. Cerca log:
   ```json
   {
