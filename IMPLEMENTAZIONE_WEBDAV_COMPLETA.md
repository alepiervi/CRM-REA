...
curl https://clientmanage-2.preview.emergentagent.com/api/documents/upload-debug
...
4. Controlla endpoint debug:
   ```
   https://clientmanage-2.preview.emergentagent.com/api/documents/upload-debug
   ```
5. Cerca log:
   ```json
   {
