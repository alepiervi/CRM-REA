...
curl https://commessa-crm-hub.preview.emergentagent.com/api/documents/upload-debug
...
4. Controlla endpoint debug:
   ```
   https://commessa-crm-hub.preview.emergentagent.com/api/documents/upload-debug
   ```
5. Cerca log:
   ```json
   {
