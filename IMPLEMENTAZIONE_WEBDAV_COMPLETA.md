...
curl https://crm-workflow-boost.preview.emergentagent.com/api/documents/upload-debug
...
4. Controlla endpoint debug:
   ```
   https://crm-workflow-boost.preview.emergentagent.com/api/documents/upload-debug
   ```
5. Cerca log:
   ```json
   {
