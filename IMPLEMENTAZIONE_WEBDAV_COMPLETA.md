...
curl https://nureal-crm-rbac.preview.emergentagent.com/api/documents/upload-debug
...
4. Controlla endpoint debug:
   ```
   https://nureal-crm-rbac.preview.emergentagent.com/api/documents/upload-debug
   ```
5. Cerca log:
   ```json
   {
