...
curl https://agent-portal-43.preview.emergentagent.com/api/documents/upload-debug
...
4. Controlla endpoint debug:
   ```
   https://agent-portal-43.preview.emergentagent.com/api/documents/upload-debug
   ```
5. Cerca log:
   ```json
   {
