...
const getBackendURL = () => {
  const forcedURL = 'https://client-manager-131.preview.emergentagent.com';
...
async function keepAlive() {
  await fetch('https://client-manager-131.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://client-manager-131.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://client-manager-131.preview.emergentagent.com/api/health
```
