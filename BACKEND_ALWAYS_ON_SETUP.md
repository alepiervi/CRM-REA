...
const getBackendURL = () => {
  const forcedURL = 'https://agent-portal-43.preview.emergentagent.com';
...
async function keepAlive() {
  await fetch('https://agent-portal-43.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://agent-portal-43.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://agent-portal-43.preview.emergentagent.com/api/health
```
