...
const getBackendURL = () => {
  const forcedURL = 'https://agentify-6.preview.emergentagent.com';
...
curl https://agentify-6.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://agentify-6.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://agentify-6.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://agentify-6.preview.emergentagent.com/api/health
```
