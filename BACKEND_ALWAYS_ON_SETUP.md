...
const getBackendURL = () => {
  const forcedURL = 'https://lead-master-7.preview.emergentagent.com';
...
curl https://lead-master-7.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://lead-master-7.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://lead-master-7.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://lead-master-7.preview.emergentagent.com/api/health
```
