...
const getBackendURL = () => {
  const forcedURL = 'https://nureal-crm-1.preview.emergentagent.com';
...
curl https://nureal-crm-1.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://nureal-crm-1.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://nureal-crm-1.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://nureal-crm-1.preview.emergentagent.com/api/health
```
