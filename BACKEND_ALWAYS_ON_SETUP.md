...
const getBackendURL = () => {
  const forcedURL = 'https://lead-manager-56.preview.emergentagent.com';
...
curl https://lead-manager-56.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://lead-manager-56.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://lead-manager-56.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://lead-manager-56.preview.emergentagent.com/api/health
```
