...
const getBackendURL = () => {
  const forcedURL = 'https://crm-bug-tracker.preview.emergentagent.com';
...
curl https://crm-bug-tracker.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://crm-bug-tracker.preview.emergentagent.com/api/health');
}
```
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://crm-bug-tracker.preview.emergentagent.com/api/health
```
