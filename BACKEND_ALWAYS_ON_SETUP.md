...
const getBackendURL = () => {
  const forcedURL = 'https://referente-oversight.preview.emergentagent.com';
...
async function keepAlive() {
  await fetch('https://referente-oversight.preview.emergentagent.com/api/health');
}
```
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://referente-oversight.preview.emergentagent.com/api/health
```
