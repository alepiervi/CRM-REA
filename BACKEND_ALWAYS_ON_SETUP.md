...
const getBackendURL = () => {
  const forcedURL = 'https://cloudfile-fix.preview.emergentagent.com';
...
```bash
CORS_ORIGINS="https://nureal.it,https://www.nureal.it,https://cloudfile-fix.preview.emergentagent.com"
```
...
curl https://cloudfile-fix.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://cloudfile-fix.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://cloudfile-fix.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://cloudfile-fix.preview.emergentagent.com/api/health
```
