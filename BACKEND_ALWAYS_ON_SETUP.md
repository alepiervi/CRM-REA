...
const getBackendURL = () => {
  const forcedURL = 'https://commessa-crm-hub.preview.emergentagent.com';
...
```bash
CORS_ORIGINS="https://nureal.it,https://www.nureal.it,https://commessa-crm-hub.preview.emergentagent.com"
```
...
curl https://commessa-crm-hub.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://commessa-crm-hub.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://commessa-crm-hub.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://commessa-crm-hub.preview.emergentagent.com/api/health
```
