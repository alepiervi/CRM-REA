...
const getBackendURL = () => {
  const forcedURL = 'https://leadmanager-21.preview.emergentagent.com';
...
curl https://leadmanager-21.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://leadmanager-21.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://leadmanager-21.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://leadmanager-21.preview.emergentagent.com/api/health
```
