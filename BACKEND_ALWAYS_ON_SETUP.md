...
const getBackendURL = () => {
  const forcedURL = 'https://bulk-upload-clients.preview.emergentagent.com';
...
curl https://bulk-upload-clients.preview.emergentagent.com/api/health
...
async function keepAlive() {
  await fetch('https://bulk-upload-clients.preview.emergentagent.com/api/health');
}
```
...
2. Add Monitor:
   - URL: https://bulk-upload-clients.preview.emergentagent.com/api/health
   - Interval: 5 minutes
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://bulk-upload-clients.preview.emergentagent.com/api/health
```
