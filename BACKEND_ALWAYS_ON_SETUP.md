...
const getBackendURL = () => {
  const forcedURL = 'https://lead2ai-flow.preview.emergentagent.com';
...
async function keepAlive() {
  await fetch('https://lead2ai-flow.preview.emergentagent.com/api/health');
}
```
...
jobs:
  ping:
    ...
    steps:
      - run: curl https://lead2ai-flow.preview.emergentagent.com/api/health
```
