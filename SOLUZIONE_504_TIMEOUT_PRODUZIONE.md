...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://crm-workflow-boost.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://crm-workflow-boost.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://crm-workflow-boost.preview.emergentagent.com
   ↓
