...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://role-manager-19.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://role-manager-19.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://role-manager-19.preview.emergentagent.com
   ↓
...
# 📡 Backend URL configured: https://role-manager-19.preview.emergentagent.com
```
...
# Request URL: https://role-manager-19.preview.emergentagent.com/api/documents/upload
...
✅ Production environment detected - using preview backend (no timeout)
📡 Backend URL configured: https://role-manager-19.preview.emergentagent.com
📡 API endpoint: https://role-manager-19.preview.emergentagent.com/api
```
