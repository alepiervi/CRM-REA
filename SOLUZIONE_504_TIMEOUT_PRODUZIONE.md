...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://client-manager-131.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://client-manager-131.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://client-manager-131.preview.emergentagent.com
   ↓
...
# Request URL: https://client-manager-131.preview.emergentagent.com/api/documents/upload
