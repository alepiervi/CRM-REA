...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://nureal-crm-1.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://nureal-crm-1.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://nureal-crm-1.preview.emergentagent.com
   ↓
...
# Request URL: https://nureal-crm-1.preview.emergentagent.com/api/documents/upload
