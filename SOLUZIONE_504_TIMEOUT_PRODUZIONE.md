...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://bulk-upload-clients.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://bulk-upload-clients.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://bulk-upload-clients.preview.emergentagent.com
   ↓
...
# Request URL: https://bulk-upload-clients.preview.emergentagent.com/api/documents/upload
