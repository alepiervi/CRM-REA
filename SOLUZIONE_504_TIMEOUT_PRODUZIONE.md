...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://crm-bug-tracker.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://crm-bug-tracker.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://crm-bug-tracker.preview.emergentagent.com
   ↓
...
# Request URL: https://crm-bug-tracker.preview.emergentagent.com/api/documents/upload
