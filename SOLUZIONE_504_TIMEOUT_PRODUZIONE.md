...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://agent-portal-43.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://agent-portal-43.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://agent-portal-43.preview.emergentagent.com
   ↓
...
# Request URL: https://agent-portal-43.preview.emergentagent.com/api/documents/upload
