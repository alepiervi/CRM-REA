...
if (hostname === 'nureal.it' || hostname === 'www.nureal.it') {
    ...
    return 'https://lead2ai-flow.preview.emergentagent.com';  // ✅ No timeout
}
```
...
production_domains = [
    ...
    "https://lead2ai-flow.preview.emergentagent.com",  # ✅ Aggiunto
]
```
...
1. User su https://nureal.it
   ↓
2. Frontend usa: https://lead2ai-flow.preview.emergentagent.com
   ↓
...
# 📡 Backend URL configured: https://lead2ai-flow.preview.emergentagent.com
```
...
# Request URL: https://lead2ai-flow.preview.emergentagent.com/api/documents/upload
...
✅ Production environment detected - using preview backend (no timeout)
📡 Backend URL configured: https://lead2ai-flow.preview.emergentagent.com
📡 API endpoint: https://lead2ai-flow.preview.emergentagent.com/api
```
