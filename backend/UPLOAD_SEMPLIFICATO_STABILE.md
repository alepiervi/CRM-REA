...
```javascript
if (hostname === 'nureal.it') {
    return 'https://mobil-analytics-2.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://mobil-analytics-2.preview.emergentagent.com/api/documents/upload
   ↓
...
📡 Backend URL: https://mobil-analytics-2.preview.emergentagent.com
...
**Network Tab**:
```
Request URL: https://mobil-analytics-2.preview.emergentagent.com/api/documents/upload
Status: 200 OK
Time: 10-15 seconds
```
