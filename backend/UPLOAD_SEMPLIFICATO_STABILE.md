...
```javascript
if (hostname === 'nureal.it') {
    return 'https://lead-master-7.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://lead-master-7.preview.emergentagent.com/api/documents/upload
   ↓
...
📡 Backend URL: https://lead-master-7.preview.emergentagent.com
