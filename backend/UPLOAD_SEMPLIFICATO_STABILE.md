...
```javascript
if (hostname === 'nureal.it') {
    return 'https://client-manager-131.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://client-manager-131.preview.emergentagent.com/api/documents/upload
   ↓
...
📡 Backend URL: https://client-manager-131.preview.emergentagent.com
