...
```javascript
if (hostname === 'nureal.it') {
    return 'https://agent-portal-43.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://agent-portal-43.preview.emergentagent.com/api/documents/upload
   ↓
