...
```javascript
if (hostname === 'nureal.it') {
    return 'https://nureal-crm-2.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://nureal-crm-2.preview.emergentagent.com/api/documents/upload
   ↓
...
📡 Backend URL: https://nureal-crm-2.preview.emergentagent.com
