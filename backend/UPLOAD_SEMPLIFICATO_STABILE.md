...
```javascript
if (hostname === 'nureal.it') {
    return 'https://cloudfile-fix.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://cloudfile-fix.preview.emergentagent.com/api/documents/upload
   ↓
...
📡 Backend URL: https://cloudfile-fix.preview.emergentagent.com
