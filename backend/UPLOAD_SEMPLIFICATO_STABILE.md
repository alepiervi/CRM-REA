...
```javascript
if (hostname === 'nureal.it') {
    return 'https://agentify-6.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://agentify-6.preview.emergentagent.com/api/documents/upload
   ↓
