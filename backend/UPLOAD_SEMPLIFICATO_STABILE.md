...
```javascript
if (hostname === 'nureal.it') {
    return 'https://client-search-fix-3.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://client-search-fix-3.preview.emergentagent.com/api/documents/upload
   ↓
