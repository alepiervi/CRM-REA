...
```javascript
if (hostname === 'nureal.it') {
    return 'https://crm-bug-tracker.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://crm-bug-tracker.preview.emergentagent.com/api/documents/upload
   ↓
...
📡 Backend URL: https://crm-bug-tracker.preview.emergentagent.com
