...
```javascript
if (hostname === 'nureal.it') {
    return 'https://bulk-upload-clients.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://bulk-upload-clients.preview.emergentagent.com/api/documents/upload
   ↓
