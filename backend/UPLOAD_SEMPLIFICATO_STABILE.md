...
```javascript
if (hostname === 'nureal.it') {
    return 'https://leadmanager-21.preview.emergentagent.com';  // ✅ Funziona, no timeout
}
```
...
1. User upload documento da https://nureal.it
   ↓
2. Frontend chiama: https://leadmanager-21.preview.emergentagent.com/api/documents/upload
   ↓
...
📡 Backend URL: https://leadmanager-21.preview.emergentagent.com
