...
async def configure_whatsapp(
    ...
    try:
        ...
        config_dict = {
            ...
            "webhook_url": f"{os.environ.get('WEBHOOK_BASE_URL', 'https://clientmanage-2.preview.emergentagent.com')}/api/whatsapp/webhook",
            "created_at": datetime.now(timezone.utc),
            "updated_at": datetime.now(timezone.utc)
        }
    ...
    try:
        ...
        try:
            ...
            visible_clienti = await get_clienti(
                ...
                commessa_id=None,
                sub_agenzia_id=None,  # Fixed: was sub_agenzia_id_filter
                status="all",
                tipologia_contratto="all",  # Fixed: was tipologia
                assigned_to=None,
                created_by=None,
                servizio_id="all",
                segmento="all",
