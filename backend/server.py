...
@api_router.post("/clienti/{cliente_id}/lock")
...
@api_router.delete("/clienti/{cliente_id}/lock")
...
@api_router.post("/clienti/{cliente_id}/lock/heartbeat")
...
@api_router.get("/clienti/{cliente_id}/lock")
...
@api_router.post("/clienti/{cliente_id}/lock/force-release")
