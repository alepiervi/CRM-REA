...
NUOVO:   https://agent-portal-43.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://agent-portal-43.preview.emergentagent.com
```
...
```
✅ Backend URL configured: https://agent-portal-43.preview.emergentagent.com
✅ API endpoint: https://agent-portal-43.preview.emergentagent.com/api
```
...
REACT_APP_BACKEND_URL=https://agent-portal-43.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
# CORS - CRITICO!
CORS_ORIGINS=https://nureal.it,https://www.nureal.it,https://agent-portal-43.preview.emergentagent.com
