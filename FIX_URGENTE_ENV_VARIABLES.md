...
NUOVO:   https://mobil-analytics-2.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://mobil-analytics-2.preview.emergentagent.com
```
...
REACT_APP_BACKEND_URL=https://mobil-analytics-2.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
