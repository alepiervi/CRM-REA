...
NUOVO:   https://cloudfile-fix.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://cloudfile-fix.preview.emergentagent.com
```
...
REACT_APP_BACKEND_URL=https://cloudfile-fix.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
