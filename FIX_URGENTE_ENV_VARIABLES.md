...
NUOVO:   https://commessa-crm-hub.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://commessa-crm-hub.preview.emergentagent.com
```
...
REACT_APP_BACKEND_URL=https://commessa-crm-hub.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
