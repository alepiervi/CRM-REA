...
NUOVO:   https://bulk-upload-clients.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://bulk-upload-clients.preview.emergentagent.com
```
...
```
✅ Backend URL configured: https://bulk-upload-clients.preview.emergentagent.com
✅ API endpoint: https://bulk-upload-clients.preview.emergentagent.com/api
```
...
REACT_APP_BACKEND_URL=https://bulk-upload-clients.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
# CORS - CRITICO!
CORS_ORIGINS=https://nureal.it,https://www.nureal.it,https://bulk-upload-clients.preview.emergentagent.com
