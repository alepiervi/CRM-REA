...
NUOVO:   https://lead-master-7.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://lead-master-7.preview.emergentagent.com
```
...
```
✅ Backend URL configured: https://lead-master-7.preview.emergentagent.com
✅ API endpoint: https://lead-master-7.preview.emergentagent.com/api
```
...
REACT_APP_BACKEND_URL=https://lead-master-7.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
# CORS - CRITICO!
CORS_ORIGINS=https://nureal.it,https://www.nureal.it,https://lead-master-7.preview.emergentagent.com
