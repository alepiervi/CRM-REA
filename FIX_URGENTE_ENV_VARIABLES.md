...
NUOVO:   https://crm-bug-tracker.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://crm-bug-tracker.preview.emergentagent.com
```
...
```
✅ Backend URL configured: https://crm-bug-tracker.preview.emergentagent.com
✅ API endpoint: https://crm-bug-tracker.preview.emergentagent.com/api
```
...
REACT_APP_BACKEND_URL=https://crm-bug-tracker.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
# CORS - CRITICO!
CORS_ORIGINS=https://nureal.it,https://www.nureal.it,https://crm-bug-tracker.preview.emergentagent.com
