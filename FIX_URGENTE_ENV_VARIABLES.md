...
NUOVO:   https://nureal-crm.preview.emergentagent.com
```
...
**CORS_ORIGINS**:
```
VALORE: https://nureal.it,https://www.nureal.it,https://nureal-crm.preview.emergentagent.com
```
...
```
✅ Backend URL configured: https://nureal-crm.preview.emergentagent.com
✅ API endpoint: https://nureal-crm.preview.emergentagent.com/api
```
...
REACT_APP_BACKEND_URL=https://nureal-crm.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
# CORS - CRITICO!
CORS_ORIGINS=https://nureal.it,https://www.nureal.it,https://nureal-crm.preview.emergentagent.com
