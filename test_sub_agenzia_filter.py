...
class SubAgenziaFilterTester:
    def __init__(self, base_url="https://mobil-analytics-2.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    print(f"🌐 Base URL: https://mobil-analytics-2.preview.emergentagent.com/api")
    print("=" * 80)
